...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "demo/empsal/empsal/test/integration/FirstJourney",
    "demo/empsal/empsal/test/integration/EmployeesListJourney",
    "demo/empsal/empsal/test/integration/EmployeesObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
